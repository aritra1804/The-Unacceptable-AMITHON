  ...
  return (
    <div className='xl:mt-[80px] xl:max-w-[1350px] 2xl:max-w-[1490px]  xl:mb-[-20px] mx-auto px-4 grid grid-cols-1 lg:grid-cols-4 items-center xl:ml-[80px]'>
        <div className=" xl:space-y-8 2xl:space-y-8">
            ...
            <div className="sm:hidden lg:inline-block  xl:w-[300px] xl:h-[300px] 2xl:w-[325px] 2xl:h-[325px]   justify-center bg-no-repeat xl:ml-[-20px] 2xl:ml-[-40px] bg-[#F6F6F6] shadow-xl rounded-xl"><img src={Tailwindcss} className='w-[180px] xl:mt-[85px] xl:ml-[65px]' alt='' /></div>
        </div>
        <div className=" xl:space-y-8 2xl:space-y-8">
            ...
            <div className="sm:hidden lg:inline-block  xl:w-[300px] xl:h-[300px] 2xl:w-[325px] 2xl:h-[325px]   justify-center bg-no-repeat xl:ml-[-20px] 2xl:ml-[-40px] bg-[#6F5DE0] shadow-xl rounded-xl"><img src={Vercel} className='w-[200px] xl:mt-[120px] xl:ml-[48px]' alt='' /></div>
        </div>
        <div className=" xl:space-y-8 2xl:space-y-8">
            ...
            <div className="sm:hidden lg:inline-block  xl:w-[300px] xl:h-[300px] 2xl:w-[325px] 2xl:h-[325px]   justify-center bg-no-repeat xl:ml-[-20px] 2xl:ml-[-40px] bg-[#F6F6F6] shadow-xl rounded-xl"><img src={Tensorflow} className='w-[200px] xl:mt-[50px] xl:ml-[48px]' alt='' /></div>
        </div>
        <div className=" xl:space-y-8 2xl:space-y-8">
            ...
            <div className="sm:hidden lg:inline-block  xl:w-[300px] xl:h-[300px] 2xl:w-[325px] 2xl:h-[325px]   justify-center bg-no-repeat xl:ml-[-20px] 2xl:ml-[-40px] bg-[#6F5DE0] shadow-xl rounded-xl"><img src={Firebase} className='w-[200px] xl:mt-[50px] xl:ml-[50px]' alt='' /></div>
        </div>
    </div>
  );
}
